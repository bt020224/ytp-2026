...
export const STRINGS: Record<string, L> = {
  ...
  navHome: { zh: "首頁", en: "Home", ja: "ホーム", ko: "홈" },
  navPlan: {
    zh: "規劃路線",
    en: "Plan Route",
    ja: "ルート計画",
  ...
  homeHeroTitle: {
    zh: "在台北玩出新花樣",
    en: "Find your fun in Taipei",
    ja: "台北で新しい楽しみを見つけよう",
    ko: "타이베이에서 즐거움을 찾다",
  },
  homeHeroSubtitle: {
    zh: "AI 即時情境推薦 · 多模式路線 · 一鍵購票",
    en: "AI context-aware picks · Multi-modal routes · One-tap tickets",
    ja: "AIが状況に応じて提案 · マルチモーダルルート · ワンタップ購入",
    ko: "AI 맞춤 추천 · 멀티모달 경로 · 원터치 구매",
  },
  homeExploreNearby: {
    zh: "📍 探索我附近",
    en: "📍 Explore Nearby",
  ...
  homeStartPlanDesc: {
    zh: "從 A 點到 B 點，比較捷運／公車／步行費用與時間",
    en: "Compare MRT / bus / walk fares and times from A to B",
    ja: "AからBまでの料金と時間を比較",
    ko: "A에서 B까지 요금과 시간 비교",
  },
  homeStartItinerary: {
    zh: "AI 安排一日行程",
    en: "Plan a Day Trip with AI",
    ja: "AIで1日の旅程を計画",
    ko: "AI로 하루 일정 짜기",
  },
  homeStartItineraryDesc: {
    zh: "選主題 → AI 排好 → 你還能調整",
    en: "Pick a theme → AI orders stops → you can edit",
    ja: "テーマを選んでAIが順番を決定、編集も可能",
    ko: "테마 선택 → AI가 동선 정렬 → 수정 가능",
  },
  ...
  itinerarySubtitle: {
    zh: "AI 自動排序，你可任意調整",
    en: "AI auto-orders, you can edit anything",
    ja: "AIが自動で並べ、自由に編集できます",
    ko: "AI가 자동 정렬하고 자유롭게 편집",
  },
  themeLabel: { zh: "主題", en: "Theme", ja: "テーマ", ko: "테마" },
  themeFood: {
    zh: "夜間美食",
    en: "Night Food",
    ja: "夜のグルメ",
  ...
  emptyItinerary: {
    zh: "尚未安排站點。先按上方「AI 自動排行程」或下方「新增站點」。",
    en: "No stops yet. Click 'Auto-plan with AI' or 'Add stop' below.",
    ja: "まだスポットがありません。上の「AIで自動計画」か下の「スポット追加」を押してください。",
    ko: "아직 일정이 없습니다. 'AI 자동 계획' 또는 '방문지 추가'를 누르세요.",
  },
  addStop: {
    zh: "➕ 新增站點",
    en: "➕ Add stop",
  ...
  moveUp: { zh: "上移", en: "Move up", ja: "上へ", ko: "위로" },
  moveDown: { zh: "下移", en: "Move down", ja: "下へ", ko: "아래로" },
  itinerarySummary: {
    zh: "行程總結",
    en: "Trip Summary",
    ja: "旅程まとめ",
  ...
  noNearby: {
    zh: "目前位置 0.5 公里內沒有預載景點，請使用「規劃路線」",
